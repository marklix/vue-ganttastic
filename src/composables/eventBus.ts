...
type plannerRefreshPayload = {
  componentId: string;
  type: "add" | "delete";
  values: Record<string, GanttBarObject | string>;
};

type plannerBusEvents = Record<string, plannerRefreshPayload | unknown>;

export { plannerBusEvents, plannerRefreshPayload };
