<template>
  <div id="g-gantt-chart" ref="gGanttChart" :style="{ width, fontFamily: font }">
    <g-gantt-timeaxis v-if="!hideTimeaxis" :chart-start="chartStart" :chart-end="chartEnd" :precision="precision">
...
const emit = defineEmits<{
  ...
  (
    e: "dragend-bar",
    value: { bar: GanttBarObject; e: MouseEvent; movedBars?: Map<GanttBarObject, { oldStart: string; oldEnd: string }> }
  ): void;
